...
namespace Baci.ArcGIS.Geoprocessor.PublicTransitTools
{
	...
	/// <para>GTFS 转公共交通数据模型</para>
	/// <para>可将一个或多个通用交通数据规范 (GTFS) 公共交通数据集转换为一组要素类和表，这些要素类和表以 Network Analyst 公共交通数据模型定义的格式表示公交站点、线路和时间表。</para>
	/// </summary>
	public class GTFSToPublicTransitDataModel : AbstractGPProcess
	{
		...
		/// <summary>
		/// <para>Tool Display Name : GTFS 转公共交通数据模型</para>
		/// </summary>
		public override string DisplayName() => "GTFS 转公共交通数据模型";
		...
		/// <para>未选中 - 不追加数据。 将覆盖现有要素类和表。 这是默认设置。</para>
