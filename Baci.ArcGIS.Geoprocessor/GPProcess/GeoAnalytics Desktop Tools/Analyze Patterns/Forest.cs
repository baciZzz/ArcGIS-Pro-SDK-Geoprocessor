...
namespace Baci.ArcGIS.Geoprocessor.GeoAnalyticsDesktopTools
{
	...
	public class Forest : AbstractGPProcess
	{
		...
		/// </param>
		/// <param name="OutputTrainedFeatures">
		...
		/// </param>
		public Forest(object PredictionType, object InFeatures, object OutputTrainedFeatures, object VariablePredict)
		{
			this.PredictionType = PredictionType;
			this.InFeatures = InFeatures;
			this.OutputTrainedFeatures = OutputTrainedFeatures;
		...
		/// <para>A table containing information describing the importance of each explanatory variable to be used in the created model.</para>
		/// </summary>
		[ParamType(ParamTypeEnum.optional)]
		[DETable()]
		...
		/// <para>The output feature class that will receive the results of the prediction results.</para>
		/// </summary>
		[ParamType(ParamTypeEnum.optional)]
		[GPComposite()]
		[Category("Additional Outputs")]
