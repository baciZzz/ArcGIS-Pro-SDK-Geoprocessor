...
namespace Baci.ArcGIS.Geoprocessor.AnalysisTools
{
    ...
    public class Intersect2 : AbstractGPProcess
    {
        /// <summary>
        ...
        /// </param>
        public Intersect2(object InFeatures, object OutFeatureClass)
        {
        ...
        /// </summary>
        [ParamType(ParamTypeEnum.optional)]
        public Param OutputTypeParam { get; set; } = new Param()
        {
            Value = "INPUT",
            Domain = new GPCodedValueDomainAttribute()
            {
                Items = [
                    new CodedValue() {
                        Code = "Same as input",
                        Value = "INPUT",
                        Description = "The intersections returned will be the same geometry type as the input features with the lowest " +
                        "dimension geometry. If all inputs are polygons, the output feature class will contain polygons. If one or more of " +
                        "the inputs are lines and none of the inputs are points, the output will be line. If one or more of the inputs are " +
                        "points, the output feature class will contain points. This is the default."
                    },
                    new CodedValue() { Code = "Line", Value = "LINE" },
                    new CodedValue() { Code = "Point", Value = "POINT" },
                    ]
            }
        };
        /// <summary>
