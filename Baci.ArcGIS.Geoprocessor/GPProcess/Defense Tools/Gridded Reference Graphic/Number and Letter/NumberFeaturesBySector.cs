...
namespace Baci.ArcGIS.Geoprocessor.DefenseTools
{
	...
	/// </summary>
	[InputWillBeModified()]
	public class NumberFeaturesBySector : AbstractGPProcess
	{
		/// <summary>
		...
		public NumberFeaturesBySector(object InFeatures, object SectorPolygons, object FieldToNumber)
		{
			...
			this.SectorPolygons = SectorPolygons;
		...
		/// </summary>
		public override string ToolName() => "NumberFeaturesBySector";

		/// <summary>
		/// <para>Tool Excute Name : defense.NumberFeaturesBySector</para>
		/// </summary>
		public override string ExcuteName() => "defense.NumberFeaturesBySector";
		...
		/// </summary>
		public override object[] Parameters() => new object[] { InFeatures, SectorPolygons, FieldToNumber, NewFieldType!, SpatialSortMethod!, IncrementBy!, CenterPoint!, AddDistanceAndBearing!, OutFeatureClass! };
		...
		[FeatureType("Simple")]
		public object SectorPolygons { get; set; }
		...
		[ParamType(ParamTypeEnum.optional)]
		[GPLong()]
		public object? IncrementBy { get; set; } = "1000";
		...
		/// </summary>
		public NumberFeaturesBySector SetEnviroment(object? extent = null , object? scratchWorkspace = null , object? workspace = null )
		{
