...
namespace Baci.ArcGIS.Geoprocessor.DataManagementTools
{
	...
	public class ExportTileCache : AbstractGPProcess
	{
		...
		/// <para>紧凑型 v2— 仅能将切片组织到包文件中。这种格式使得网络共享和云存储目录拥有了更好的性能。如果将导出缓存类型参数设置为切片包 (tpkx)，则切片包的扩展名为较新版本的 ArcGIS 平台，如 ArcGIS Online、ArcGIS Enterprise 10.9 和 ArcGIS Runtime 100.5 均支持的 (.tpkx)。这是默认设置。</para>
