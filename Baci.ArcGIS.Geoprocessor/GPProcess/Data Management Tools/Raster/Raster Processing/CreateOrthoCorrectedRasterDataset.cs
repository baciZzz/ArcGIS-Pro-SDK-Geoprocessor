...
namespace Baci.ArcGIS.Geoprocessor.DataManagementTools
{
	...
	public class CreateOrthoCorrectedRasterDataset : AbstractGPProcess
	{
		...
		/// <para>When storing a raster dataset to a JPEG format file, a JPEG 2000 format file, or a geodatabase, you can specify a Compression Type value and a Compression Quality value in the geoprocessing environments.</para>
		/// </param>
