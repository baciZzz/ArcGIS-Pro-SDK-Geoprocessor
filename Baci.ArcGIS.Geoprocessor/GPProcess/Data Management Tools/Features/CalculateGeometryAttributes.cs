...
namespace Baci.ArcGIS.Geoprocessor.DataManagementTools
{
	...
	public class CalculateGeometryAttributes : AbstractGPProcess
	{
		...
		/// <para>将使用几何计算进行更新的带有字段的要素。</para>
		/// </param>
		/// <param name="GeometryProperty">
		/// <para>Geometry Attributes</para>
		/// <para>指定将在其中计算所选几何属性的字段。</para>
		/// <para>您可以选择现有字段或提供新的字段名称。 如果指定了新的字段名称，则字段类型将由写入该字段的值的类型确定。 计数属性将被写入长整型字段，面积、长度和 x、y、z 和 m 坐标属性将被写入双精度字段，而坐标记法（例如度分秒或 MGRS）将被写入文本字段。</para>
		...
		/// <para>米—长度单位将为米。</para>
		/// <para>法定英里—长度单位将为法定英里。</para>
		/// <para>国际海里—长度单位将为国际海里。</para>
		/// <para>国际码—长度单位将为国际码。</para>
		/// <para>国际英尺—长度单位将为国际英尺。</para>
		/// <para>美国测量英里—长度单位将为美国测量英里。</para>
		/// <para>美国测量海里—长度单位将为美国测量海里。</para>
		/// <para>美国测量码—长度单位将为美国测量码。</para>
		/// <para>美国测量英尺—长度单位将为美国测量英尺。</para>
		...
		/// <para>法定平方英里—面积单位将为法定平方英里。</para>
		/// <para>国际平方海里—面积单位将为国际平方海里。</para>
		/// <para>国际英亩—面积单位将为国际英亩。</para>
		/// <para>国际平方码—面积单位将为国际平方码。</para>
		/// <para>国际平方英尺—面积单位将为国际平方英尺。</para>
		/// <para>美国测量平方英里—面积单位将为美国测量平方英里。</para>
		/// <para>美国测量平方海里—面积单位将为美国测量平方海里。</para>
		/// <para>美国测量英亩—面积单位将为美国测量英亩。</para>
		/// <para>美国测量平方码—面积单位将为美国测量平方码。</para>
		/// <para>美国测量平方英尺—面积单位将为美国测量平方英尺。</para>
		/// </summary>
		[ParamType(ParamTypeEnum.optional)]
		[GPString()]
		[GPCodedValueDomain()]
		...
		/// <para>度分秒 (&lt;N|S|E|W&gt; DDD° MM&apos; SSS.ss&quot;)—在开始显示主方向组件的度分秒 (&lt;N|S|E|W&gt; DDD° MM&apos; SSS.ss&quot;)。</para>
		/// <para>度分秒 (&lt;+|-&gt; DDD° MM&apos; SSS.ss&quot;)—在开始显示正或负方向组件的度分秒 (&lt;+|-&gt; DDD° MM&apos; SSS.ss&quot;)。</para>
		...
		/// <para>十进制度分 (&lt;N|S|E|W&gt; DDD° MM.mmm&apos;)—在开始显示主方向组件的度十进制分 (&lt;N|S|E|W&gt; DDD° MM.mmm&apos;)。</para>
