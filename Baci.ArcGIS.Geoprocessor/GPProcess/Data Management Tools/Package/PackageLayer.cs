...
namespace Baci.ArcGIS.Geoprocessor.DataManagementTools
{
	...
	public class PackageLayer : AbstractGPProcess
	{
		...
		/// <para>当前版本—包中将包含与当前 ArcGIS Pro 版本兼容的地理数据库和图层文件。</para>
		/// <para>1.2—包中将包含与 ArcGIS Pro 1.2 和更高版本均兼容的地理数据库和图层文件。</para>
		/// <para>2.x—包中将包含与 ArcGIS Pro 2.0 和更高版本均兼容的地理数据库和图层文件。</para>
		/// <para>3.x—包中将包含与 ArcGIS Pro 3.0 和更高版本均兼容的地理数据库和图层文件。</para>
