...
namespace Baci.ArcGIS.Geoprocessor.DataManagementTools
{
	...
	/// <para>创建 3D 对象场景图层内容</para>
	/// <para>用于从多面体或 3D 对象要素图层输入创建场景图层包 (.slpk) 或场景图层内容 (.i3sREST)。</para>
	/// </summary>
	public class Create3DObjectSceneLayerPackage : AbstractGPProcess
	{
		...
		/// </param>
		public Create3DObjectSceneLayerPackage(object InDataset)
		{
			this.InDataset = InDataset;
		}

		/// <summary>
		/// <para>Tool Display Name : 创建 3D 对象场景图层内容</para>
		/// </summary>
		public override string DisplayName() => "创建 3D 对象场景图层内容";
