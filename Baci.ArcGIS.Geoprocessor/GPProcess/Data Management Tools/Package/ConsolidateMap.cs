...
namespace Baci.ArcGIS.Geoprocessor.DataManagementTools
{
	...
	public class ConsolidateMap : AbstractGPProcess
	{
		...
		/// <para>指定是否将输入移动地理数据库数据作为移动地理数据库保留在输出中。 当输入数据为移动地理数据库时，此参数将覆盖将数据转换为文件地理数据库参数。 如果输入数据是移动地理数据库网络数据集，则输出将始终为移动地理数据库。</para>
		/// <para>未选中 - 移动地理数据库数据将被转换为文件地理数据库。 这是默认设置。</para>
		/// <para>选中 - 在合并文件夹中，移动地理数据库数据将保留为 SQLite。</para>
