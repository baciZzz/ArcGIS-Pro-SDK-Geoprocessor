...
namespace Baci.ArcGIS.Geoprocessor.SpatialStatisticsTools
{
	...
	public class SpatialAssociationBetweenZones : AbstractGPProcess
	{
		...
		/// <para>表示输入区域的区域类别的字段。该字段的每个唯一值定义一个单独区域。对于要素，该字段必须为整型或文本字段。对于栅格，VALUE 同样受支持。</para>
		/// </param>
		...
		/// <para>表示叠加区域的区域类别的字段。该字段的每个唯一值定义一个单独区域。对于要素，该字段必须为整型或文本字段。对于栅格，VALUE 同样受支持。</para>
		/// </param>
