...
namespace Baci.ArcGIS.Geoprocessor.Analyst3DTools
{
	...
	/// <para>更改 LAS 类代码</para>
	/// <para>重新分配 .las 文件的分类代码和标记。</para>
	/// <para>Input Will Be Modified</para>
	/// </summary>
	[InputWillBeModified()]
	public class ChangeLasClassCodes : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>指定要修改的现有类代码的列表，以及将对其各自的分类代码值和分类标记进行的更改。</para>
		/// </param>
		public ChangeLasClassCodes(object InLasDataset, object ClassCodes)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : 更改 LAS 类代码</para>
		/// </summary>
		public override string DisplayName() => "更改 LAS 类代码";
