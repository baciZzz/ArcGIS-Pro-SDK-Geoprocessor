...
namespace Baci.ArcGIS.Geoprocessor.ParcelTools
{
	...
	public class EnableParcelTopology : AbstractGPProcess
	{
		...
		/// <para>The parcel fabric for which the geodatabase topology will be enabled. The input parcel fabric can be from a file geodatabase or an enterprise geodatabase.</para>
		/// </param>
