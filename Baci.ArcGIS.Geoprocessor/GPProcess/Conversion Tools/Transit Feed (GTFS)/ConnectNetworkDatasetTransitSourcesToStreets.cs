...
namespace Baci.ArcGIS.Geoprocessor.ConversionTools
{
	...
	/// <para>将交通停靠点连接到街道要素，以便在启用交通的网络数据集中使用。此工具可创建 Network Analyst 公共交通数据模型所定义的 StopsOnStreets 和 StopConnectors 要素类，并可作为较大工作流的一部分运行，以创建创建和使用具有公共交通数据的网络数据集中所描述的交通网络数据集。</para>
	/// </summary>
