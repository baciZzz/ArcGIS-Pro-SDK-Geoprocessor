...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	public class BitwiseRightShift : AbstractGPProcess
	{
		...
		/// <para>The input on which to perform the shift.</para>
		...
		/// <summary>
		/// <para>Tool Display Name : Bitwise Right Shift</para>
		/// </summary>
		public override string DisplayName => "Bitwise Right Shift";
