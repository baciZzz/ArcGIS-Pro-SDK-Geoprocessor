...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>按位右移</para>
	/// <para>对两个输入栅格的二进制值执行“按位右移”运算。</para>
	/// </summary>
	public class BitwiseRightShift : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>输出栅格。</para>
		/// <para>像元值是对输入进行“按位右移”运算的结果。</para>
		/// </param>
		public BitwiseRightShift(object InRasterOrConstant1, object InRasterOrConstant2, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : 按位右移</para>
		/// </summary>
		public override string DisplayName() => "按位右移";

		/// <summary>
		/// <para>Tool Name : BitwiseRightShift</para>
		/// </summary>
		public override string ToolName() => "BitwiseRightShift";

		/// <summary>
		/// <para>Tool Excute Name : ia.BitwiseRightShift</para>
		/// </summary>
		public override string ExcuteName() => "ia.BitwiseRightShift";
		...
		/// </summary>
		public BitwiseRightShift SetEnviroment(int? autoCommit = null , object cellSize = null , object compression = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
