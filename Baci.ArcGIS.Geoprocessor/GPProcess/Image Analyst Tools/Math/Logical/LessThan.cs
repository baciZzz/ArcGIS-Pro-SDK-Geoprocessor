...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>Less Than</para>
	/// <para>小于</para>
	/// <para>以逐个像元比较的方式对两个输入执行关系小于运算。</para>
	/// </summary>
	public class LessThan : AbstractGPProcess
	{
		...
		/// <para>将被测试以确定其是否小于第二个输入的输入。</para>
		...
		/// <summary>
		/// <para>Tool Display Name : 小于</para>
		/// </summary>
		public override string DisplayName() => "小于";
