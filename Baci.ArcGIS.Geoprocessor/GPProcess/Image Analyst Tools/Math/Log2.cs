...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	public class Log2 : AbstractGPProcess
	{
		...
		/// <para>要查找以 2 为底的对数的输入值。</para>
		/// <para>要使用数字作为此参数的输入，像元大小和范围必须先在环境中进行设置。</para>
		/// </param>
		/// <param name="OutRaster">
		/// <para>Output raster</para>
		/// <para>输出栅格。</para>
		/// <para>像元值是输入值以 2 为底的对数。</para>
		/// </param>
		...
		/// <summary>
		/// <para>Tool Excute Name : ia.Log2</para>
		/// </summary>
		public override string ExcuteName() => "ia.Log2";
		...
		/// </summary>
		public Log2 SetEnviroment(int? autoCommit = null, object cellSize = null, object configKeyword = null, object extent = null, object geographicTransformations = null, object mask = null, object outputCoordinateSystem = null, object scratchWorkspace = null, object snapRaster = null, double[] tileSize = null, object workspace = null)
		{
