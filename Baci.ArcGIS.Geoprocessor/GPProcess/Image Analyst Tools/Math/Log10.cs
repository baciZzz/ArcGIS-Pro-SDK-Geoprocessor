...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>Log10</para>
	/// <para>Log10</para>
	/// <para>计算栅格中各像元以 10 为底的对数。</para>
	/// </summary>
	public class Log10 : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>要查找以 10 为底的对数的输入值。</para>
		/// <para>要使用数字作为此参数的输入，像元大小和范围必须先在环境中进行设置。</para>
		/// </param>
		/// <param name="OutRaster">
		/// <para>Output raster</para>
		/// <para>输出栅格。</para>
		/// <para>像元值是输入值以 10 为底的对数。</para>
		/// </param>
		public Log10(object InRasterOrConstant, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : Log10</para>
		/// </summary>
		public override string DisplayName() => "Log10";

		/// <summary>
		/// <para>Tool Name : Log10</para>
		/// </summary>
		public override string ToolName() => "Log10";

		/// <summary>
		/// <para>Tool Excute Name : ia.Log10</para>
		/// </summary>
		public override string ExcuteName() => "ia.Log10";
		...
		/// </summary>
		public Log10 SetEnviroment(int? autoCommit = null , object cellSize = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
