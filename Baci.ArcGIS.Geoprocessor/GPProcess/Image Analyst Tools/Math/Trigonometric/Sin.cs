...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>Sin</para>
	/// <para>Sin</para>
	/// <para>计算栅格中各像元的正弦值。</para>
	/// </summary>
	public class Sin : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>输出栅格。</para>
		/// <para>这些值是输入值的正弦值。</para>
		/// </param>
		public Sin(object InRasterOrConstant, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : Sin</para>
		/// </summary>
		public override string DisplayName() => "Sin";

		/// <summary>
		/// <para>Tool Name : Sin</para>
		/// </summary>
		public override string ToolName() => "Sin";

		/// <summary>
		/// <para>Tool Excute Name : ia.Sin</para>
		/// </summary>
		public override string ExcuteName() => "ia.Sin";
		...
		/// </summary>
		public Sin SetEnviroment(int? autoCommit = null , object cellSize = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
