...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>ASinH</para>
	/// <para>ASinH</para>
	/// <para>计算栅格中各像元的反双曲正弦值。</para>
	/// </summary>
	public class ASinH : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>用于计算反双曲正弦值的输入数据。</para>
		/// <para>要使用数字作为此参数的输入，像元大小和范围必须先在环境中进行设置。</para>
		/// </param>
		/// <param name="OutRaster">
		/// <para>Output raster</para>
		/// <para>输出栅格。</para>
		/// <para>这些值是输入值的反双曲正弦值。</para>
		/// </param>
		public ASinH(object InRasterOrConstant, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : ASinH</para>
		/// </summary>
		public override string DisplayName() => "ASinH";

		/// <summary>
		/// <para>Tool Name : ASinH</para>
		/// </summary>
		public override string ToolName() => "ASinH";

		/// <summary>
		/// <para>Tool Excute Name : ia.ASinH</para>
		/// </summary>
		public override string ExcuteName() => "ia.ASinH";
		...
		/// </summary>
		public ASinH SetEnviroment(int? autoCommit = null , object cellSize = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
