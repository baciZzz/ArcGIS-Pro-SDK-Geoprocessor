...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	/// <summary>
	/// <para>TanH</para>
	/// <para>Calculates the hyperbolic tangent of cells in a raster.</para>
	/// </summary>
	public class TanH : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>The input to calculate the hyperbolic tangent values for.</para>
		...
		/// <para>The values are the hyperbolic tangent of the input values.</para>
		/// </param>
		public TanH(object InRasterOrConstant, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : TanH</para>
		/// </summary>
		public override string DisplayName => "TanH";

		/// <summary>
		/// <para>Tool Name : TanH</para>
		/// </summary>
		public override string ToolName => "TanH";

		/// <summary>
		/// <para>Tool Excute Name : ia.TanH</para>
		/// </summary>
		public override string ExcuteName => "ia.TanH";
		...
		/// </summary>
		public TanH SetEnviroment(int? autoCommit = null , object cellSize = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
