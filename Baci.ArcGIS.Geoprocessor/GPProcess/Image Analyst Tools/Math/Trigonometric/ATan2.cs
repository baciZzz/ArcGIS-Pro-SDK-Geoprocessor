...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	public class ATan2 : AbstractGPProcess
	{
		...
		/// <summary>
		/// <para>Tool Excute Name : ia.ATan2</para>
		/// </summary>
		public override string ExcuteName() => "ia.ATan2";
