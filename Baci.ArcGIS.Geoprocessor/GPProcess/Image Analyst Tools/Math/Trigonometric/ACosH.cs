...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>ACosH</para>
	/// <para>ACosH</para>
	/// <para>计算栅格中各像元的反双曲余弦值。</para>
	/// </summary>
	public class ACosH : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>用于计算反双曲余弦值的输入数据。</para>
		/// <para>要使用数字作为此参数的输入，像元大小和范围必须先在环境中进行设置。</para>
		/// </param>
		/// <param name="OutRaster">
		/// <para>Output raster</para>
		/// <para>输出栅格。</para>
		/// <para>这些值是输入值的反双曲余弦值。</para>
		/// </param>
		public ACosH(object InRasterOrConstant, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : ACosH</para>
		/// </summary>
		public override string DisplayName() => "ACosH";

		/// <summary>
		/// <para>Tool Name : ACosH</para>
		/// </summary>
		public override string ToolName() => "ACosH";

		/// <summary>
		/// <para>Tool Excute Name : ia.ACosH</para>
		/// </summary>
		public override string ExcuteName() => "ia.ACosH";
		...
		/// </summary>
		public ACosH SetEnviroment(int? autoCommit = null , object cellSize = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
