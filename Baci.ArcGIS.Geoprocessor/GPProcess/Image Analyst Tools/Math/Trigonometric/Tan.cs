...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>Tan</para>
	/// <para>Tan</para>
	/// <para>Calculates the tangent of cells in a raster.</para>
	/// </summary>
	public class Tan : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>The input for which to calculate the tangent values.</para>
		...
		/// <para>The values are the tangent of the input values.</para>
		/// </param>
		public Tan(object InRasterOrConstant, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Excute Name : ia.Tan</para>
		/// </summary>
		public override string ExcuteName() => "ia.Tan";
		...
		/// </summary>
		public Tan SetEnviroment(int? autoCommit = null, object cellSize = null, object configKeyword = null, object extent = null, object geographicTransformations = null, object mask = null, object outputCoordinateSystem = null, object scratchWorkspace = null, object snapRaster = null, double[] tileSize = null, object workspace = null)
		{
