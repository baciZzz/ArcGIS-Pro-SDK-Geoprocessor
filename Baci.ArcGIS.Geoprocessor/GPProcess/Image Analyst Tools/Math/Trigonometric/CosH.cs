...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	public class CosH : AbstractGPProcess
	{
		...
		/// <summary>
		/// <para>Tool Excute Name : ia.CosH</para>
		/// </summary>
		public override string ExcuteName() => "ia.CosH";
