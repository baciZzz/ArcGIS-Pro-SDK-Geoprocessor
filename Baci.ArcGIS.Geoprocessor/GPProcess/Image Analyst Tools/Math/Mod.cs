...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	/// <para>Mod</para>
	/// <para>求模</para>
	/// <para>逐个像元地求出第一个栅格数据除以第二个栅格数据的余数（模）。</para>
	/// </summary>
	public class Mod : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>输出栅格。</para>
		/// <para>像元值为第一个输入的值除以第二个输入的值的余数。</para>
		/// </param>
		public Mod(object InRasterOrConstant1, object InRasterOrConstant2, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : 求模</para>
		/// </summary>
		public override string DisplayName() => "求模";

		/// <summary>
		/// <para>Tool Name : 求模</para>
		/// </summary>
		public override string ToolName() => "求模";

		/// <summary>
		/// <para>Tool Excute Name : ia.Mod</para>
		/// </summary>
		public override string ExcuteName() => "ia.Mod";
		...
		/// </summary>
		public Mod SetEnviroment(int? autoCommit = null, object cellSize = null, object compression = null, object configKeyword = null, object extent = null, object geographicTransformations = null, object mask = null, object outputCoordinateSystem = null, object scratchWorkspace = null, object snapRaster = null, double[] tileSize = null, object workspace = null)
		{
