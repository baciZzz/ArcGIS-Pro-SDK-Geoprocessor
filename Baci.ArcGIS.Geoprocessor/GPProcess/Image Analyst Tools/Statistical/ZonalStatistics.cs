...
namespace Baci.ArcGIS.Geoprocessor.ImageAnalystTools
{
	...
	public class ZonalStatistics : AbstractGPProcess
	{
		...
		/// <para>最近—将使用最接近所需的百分位数的可用值。在这种情况下，输出像素类型与输入值栅格的像素类型相同。</para>
