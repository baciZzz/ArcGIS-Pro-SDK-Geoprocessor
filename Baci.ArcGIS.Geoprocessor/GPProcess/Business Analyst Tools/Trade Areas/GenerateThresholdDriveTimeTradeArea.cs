...
namespace Baci.ArcGIS.Geoprocessor.BusinessAnalystTools
{
	...
	public class GenerateThresholdDriveTimeTradeArea : AbstractGPProcess
	{
		...
		/// <para>The method of travel that will be used to create the output polygons.</para>
		/// </param>
		public GenerateThresholdDriveTimeTradeArea(object InFeatures, object OutFeatureClass, object ThresholdVariable, object DistanceType)
		{
		...
		/// <para>The distance units that will be used with the threshold values.</para>
		/// </summary>
		[ParamType(ParamTypeEnum.optional)]
		[GPString()]
		...
		/// <para>Specifies the direction of travel that will be used for output polygon creation.</para>
		...
		/// <para>A fields-based expression that will be used to calculate drive time.</para>
		/// </summary>
		[ParamType(ParamTypeEnum.optional)]
		[GPSQLExpression()]
