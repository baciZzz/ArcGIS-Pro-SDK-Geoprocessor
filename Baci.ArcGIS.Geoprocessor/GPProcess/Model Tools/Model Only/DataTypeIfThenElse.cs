...
namespace Baci.ArcGIS.Geoprocessor.ModelTools
{
	...
	/// <para>如果数据类型为</para>
	/// <para>用于评估输入数据是否与指定数据类型相匹配。</para>
	/// </summary>
	public class DataTypeIfThenElse : AbstractGPProcess
	{
		...
		/// <para>Z 值域—Z 值域</para>
		/// </param>
		public DataTypeIfThenElse(object InData, object DataType)
		{
			this.InData = InData;
		...
		/// <summary>
		/// <para>Tool Display Name : 如果数据类型为</para>
		/// </summary>
		public override string DisplayName() => "如果数据类型为";

		/// <summary>
		/// <para>Tool Name : DataTypeIfThenElse</para>
		/// </summary>
		public override string ToolName() => "DataTypeIfThenElse";

		/// <summary>
		/// <para>Tool Excute Name : mb.DataTypeIfThenElse</para>
		/// </summary>
		public override string ExcuteName() => "mb.DataTypeIfThenElse";
