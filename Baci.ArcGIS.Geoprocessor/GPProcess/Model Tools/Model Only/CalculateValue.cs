...
namespace Baci.ArcGIS.Geoprocessor.ModelTools
{
	...
	public class CalculateValue : AbstractGPProcess
	{
		...
		/// <summary>
		/// <para>Tool Excute Name : mb.CalculateValue</para>
		/// </summary>
		public override string ExcuteName() => "mb.CalculateValue";
		...
		/// <para>Python 代码块。可以在表达式参数中引用代码块中的代码。</para>
		/// </summary>
		...
		/// <summary>
		/// <para>Data type</para>
		/// <para>指定从 Python 表达式返回的输出的数据类型。应在 ModelBuilder 中使用此参数，以便将计算值工具与其他工具相连接。</para>
