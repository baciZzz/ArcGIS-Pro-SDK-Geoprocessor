...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	/// <para>路径距离回溯链接</para>
	/// <para>考虑表面距离以及水平和垂直成本因素的情况下，定义最小成本源的最小累积成本路径上的下一相邻像元。</para>
	...
	public class PathBackLink : AbstractGPProcess
	{
		/// <summary>
		...
		/// </param>
		public PathBackLink(object InSourceData, object OutBacklinkRaster)
		{
			this.InSourceData = InSourceData;
			this.OutBacklinkRaster = OutBacklinkRaster;
		}

		/// <summary>
		/// <para>Tool Display Name : 路径距离回溯链接</para>
		/// </summary>
		public override string DisplayName() => "路径距离回溯链接";
