...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	public class DistanceAllocation : AbstractGPProcess
	{
		...
		/// <para>输出距离分配栅格。</para>
		/// </param>
		public DistanceAllocation(object InSourceData, object OutDistanceAllocationRaster)
		{
			this.InSourceData = InSourceData;
			this.OutDistanceAllocationRaster = OutDistanceAllocationRaster;
		}
		...
		/// <summary>
		/// <para>Tool Excute Name : sa.DistanceAllocation</para>
		/// </summary>
		public override string ExcuteName() => "sa.DistanceAllocation";
		...
		[ParamType(ParamTypeEnum.must)]
		[DERasterDataset()]
		public object OutDistanceAllocationRaster { get; set; }
