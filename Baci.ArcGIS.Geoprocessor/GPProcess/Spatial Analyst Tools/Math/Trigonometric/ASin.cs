...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	public class ASin : AbstractGPProcess
	{
		...
		/// <summary>
		/// <para>Tool Excute Name : sa.ASin</para>
		/// </summary>
		public override string ExcuteName() => "sa.ASin";
