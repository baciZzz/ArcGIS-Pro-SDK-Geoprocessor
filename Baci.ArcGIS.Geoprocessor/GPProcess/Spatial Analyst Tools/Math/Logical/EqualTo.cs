...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	/// <para>Equal To</para>
	/// <para>等于</para>
	/// <para>以逐个像元比较的方式对两个输入执行关系等于运算。</para>
	/// </summary>
	public class EqualTo : AbstractGPProcess
	{
		...
		/// <summary>
		/// <para>Tool Display Name : 等于</para>
		/// </summary>
		public override string DisplayName() => "等于";
