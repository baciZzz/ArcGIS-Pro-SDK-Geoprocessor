...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	/// <summary>
	/// <para>Equal To</para>
	/// <para>Performs a Relational equal-to operation on two inputs on a cell-by-cell basis.</para>
	/// </summary>
	public class EqualTo : AbstractGPProcess
	{
		/// <summary>
		...
		/// <para>The input that will be compared to for equality by the second input.</para>
		...
		/// <para>The input that will be compared from for equality by the first input.</para>
		/// <para>A number can be used as an input for this parameter, provided a raster is specified for the other parameter. To specify a number for both inputs, the cell size and extent must first be set in the environment.</para>
		/// </param>
		...
		/// </param>
		public EqualTo(object InRasterOrConstant1, object InRasterOrConstant2, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : Equal To</para>
		/// </summary>
		public override string DisplayName() => "Equal To";

		/// <summary>
		/// <para>Tool Name : EqualTo</para>
		/// </summary>
		public override string ToolName() => "EqualTo";

		/// <summary>
		/// <para>Tool Excute Name : sa.EqualTo</para>
		/// </summary>
		public override string ExcuteName() => "sa.EqualTo";
		...
		/// </summary>
		public EqualTo SetEnviroment(int? autoCommit = null , object cellSize = null , object compression = null , object configKeyword = null , object extent = null , object geographicTransformations = null , object mask = null , object outputCoordinateSystem = null , object scratchWorkspace = null , object snapRaster = null , double[] tileSize = null , object workspace = null )
		{
