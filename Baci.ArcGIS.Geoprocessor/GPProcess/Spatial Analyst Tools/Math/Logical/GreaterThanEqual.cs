...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	public class GreaterThanEqual : AbstractGPProcess
	{
		...
		/// </summary>
		public override string ToolName => "GreaterThanEqual";

		/// <summary>
		/// <para>Tool Excute Name : sa.GreaterThanEqual</para>
		/// </summary>
		public override string ExcuteName => "sa.GreaterThanEqual";
