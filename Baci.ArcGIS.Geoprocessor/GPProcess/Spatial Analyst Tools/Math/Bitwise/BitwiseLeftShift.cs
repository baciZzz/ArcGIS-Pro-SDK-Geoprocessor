...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	/// <para>按位左移</para>
	/// <para>对两个输入栅格的二进制值执行“按位左移”运算。</para>
	/// </summary>
	public class BitwiseLeftShift : AbstractGPProcess
	{
		...
		/// <para>输出栅格。</para>
		/// <para>像元值是对输入进行“按位左移”运算的结果。</para>
		/// </param>
		public BitwiseLeftShift(object InRasterOrConstant1, object InRasterOrConstant2, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : 按位左移</para>
		/// </summary>
		public override string DisplayName() => "按位左移";
		...
		/// <summary>
		/// <para>Tool Excute Name : sa.BitwiseLeftShift</para>
		/// </summary>
		public override string ExcuteName() => "sa.BitwiseLeftShift";
		...
		/// </summary>
		public BitwiseLeftShift SetEnviroment(int? autoCommit = null, object cellSize = null, object compression = null, object configKeyword = null, object extent = null, object geographicTransformations = null, object mask = null, object outputCoordinateSystem = null, object scratchWorkspace = null, object snapRaster = null, double[] tileSize = null, object workspace = null)
		{
