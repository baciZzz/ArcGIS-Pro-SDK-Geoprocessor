...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	/// <para>等于频数</para>
	/// <para>逐个像元评估一组栅格中的值与其他栅格相等的次数。</para>
	/// </summary>
	public class EqualToFrequency : AbstractGPProcess
	{
		...
		/// <para>针对输入值栅格中的每个像元位置，计算输入列表中的栅格具有相等值的次数（频数）。</para>
		/// </param>
		...
		/// <para>输出栅格。</para>
		/// <para>对于输出栅格中的每个像元，该值表示栅格列表中的相应像元等于值栅格的次数。</para>
		/// </param>
		public EqualToFrequency(object InValueRaster, object InRasters, object OutRaster)
		{
		...
		/// <summary>
		/// <para>Tool Display Name : 等于频数</para>
		/// </summary>
		public override string DisplayName() => "等于频数";
