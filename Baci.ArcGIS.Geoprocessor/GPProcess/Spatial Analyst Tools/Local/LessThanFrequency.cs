...
namespace Baci.ArcGIS.Geoprocessor.SpatialAnalystTools
{
	...
	/// <para>Evaluates on a cell-by-cell basis the number of times a set of rasters is less than another raster.</para>
	/// </summary>
	public class LessThanFrequency : AbstractGPProcess
	{
		...
		/// <para>For each cell location in the input value raster, the number of occurrences (frequency) where a raster in the input list has a lesser value is counted.</para>
		/// </param>
		...
		/// <para>For each cell in the output raster, the value represents the number of times that the corresponding cells in the list of rasters is less than the value raster.</para>
		/// </param>
		...
		/// <summary>
		/// <para>Tool Display Name : Less Than Frequency</para>
		/// </summary>
		public override string DisplayName => "Less Than Frequency";
