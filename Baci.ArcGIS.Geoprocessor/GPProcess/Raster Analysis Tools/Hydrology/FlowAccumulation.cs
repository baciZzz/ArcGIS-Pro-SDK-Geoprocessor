...
namespace Baci.ArcGIS.Geoprocessor.RasterAnalysisTools
{
	...
	public class FlowAccumulation : AbstractGPProcess
	{
		...
		/// <para>转为浮点型—输出栅格将为浮点型。 这是默认设置。</para>
		/// <para>整型—输出栅格将为整型。</para>
		/// <para>双精度—输出栅格将为双精度型。</para>
		...
		/// </summary>
		public FlowAccumulation SetEnviroment(object? cellSize = null , object? extent = null , object? mask = null , object? outputCoordinateSystem = null , object? pyramid = null , object? snapRaster = null )
		{
