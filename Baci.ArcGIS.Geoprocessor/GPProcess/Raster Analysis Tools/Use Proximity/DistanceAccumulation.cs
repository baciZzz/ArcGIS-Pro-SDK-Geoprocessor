...
namespace Baci.ArcGIS.Geoprocessor.RasterAnalysisTools
{
	...
	public class DistanceAccumulation : AbstractGPProcess
	{
		...
		/// <para>输入源位置。</para>
		/// <para>此为影像服务或要素服务，用于标识计算每个输出像元位置的最小积累成本距离所依据的像元或位置。</para>
		...
		/// </summary>
		public DistanceAccumulation SetEnviroment(object? cellSize = null, object? extent = null, object? mask = null, object? outputCoordinateSystem = null, object? pyramid = null, object? snapRaster = null)
		{
