...
namespace Baci.ArcGIS.Geoprocessor.RasterAnalysisTools
{
	...
	public class DistanceAccumulation : AbstractGPProcess
	{
		...
		/// <para>This is an image service or feature service identifying the cells or locations from which, or to which, the least accumulated cost distance for every output cell location is calculated.</para>
